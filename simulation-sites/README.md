...
5. Set the campaign **Fake login page URL** in KeyTrain Learning to `https://your-domain.com/`.
...
Users are redirected to the main KeyTrain Learning app at `/phishing-training?token=...` (hosted on GitHub Pages). No extra hosting required for that page.
