-- Creating an org inserted membership is_active=true, then profile UPDATE synced is_active=false
-- for inactive org admins — breaking switch/create follow-up.
...
BEGIN
  ...
  -- Profile sync trigger may copy is_active=false from inactive accounts — restore admin membership.
