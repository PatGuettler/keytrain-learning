...
(
  ...
  '<table width="600" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#333333;"><tr><td style="padding:20px 24px;background-color:#0078D4;color:#ffffff;font-size:20px;font-weight:bold;">IT Support</td></tr><tr><td style="padding:24px;"><p>Hello {{FIRST_NAME}},</p><p>Your account at {{COMPANY_NAME}} requires a password reset within 24 hours. Reference ticket <strong>#INC-{{RANDOM_5_DIGITS}}</strong>.</p><p>Failure to reset may result in account lockout.</p><p style="margin-top:24px;"><a href="{{TRACKING_LINK}}" style="background-color:#0078D4;color:#ffffff;padding:12px 24px;text-decoration:none;border-radius:4px;display:inline-block;">Reset My Password Now</a></p><p style="font-size:12px;color:#666666;margin-top:24px;">IT Helpdesk • Do not reply to this message</p></td></tr></table><img src="{{PIXEL_URL}}" width="1" height="1" style="display:none;" alt="" />',
  'Hello {{FIRST_NAME}}, your password at {{COMPANY_NAME}} expires in 24 hours. Reset here: {{TRACKING_LINK}}',
  'medium',
