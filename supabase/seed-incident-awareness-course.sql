-- Restore "Incident Awareness & Reporting" course + modules
...
-- Replace modules for this course (removes any other modules tied to this course_id)
DELETE FROM modules WHERE course_id = '10000000-0000-0000-0000-000000000001';
