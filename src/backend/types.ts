...
export interface OrganizationsBackend {
  ...
  updateOrganization(id: string, patch: { name?: string; hive_org_id?: string | null }): Promise<Organization>
...
export interface AssignmentsBackend {
  ...
  assignCourseRetake(assignmentId: string, adminId: string): Promise<void>
